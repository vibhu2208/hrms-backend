...
const tenantRoleRoutes = require('./routes/tenant/roleRoutes');
const tenantAuthRoutes = require('./routes/tenant/authRoutes');
const tenantEmployeeDashboardRoutes = require('./routes/tenant/employeeDashboardRoutes');
const tenantTestRoutes = require('./routes/tenant/testRoutes');
const testTenantRolesRoutes = require('./routes/testTenantRoles');
const debugUsersRoutes = require('./routes/debugUsers');
...
app.use('/api/tenant/employee', tenantEmployeeDashboardRoutes);
app.use('/api/tenant/test', tenantTestRoutes);
app.use('/api/test', testTenantRolesRoutes);
