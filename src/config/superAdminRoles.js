...
const PERMISSION_MATRIX = {
  [SUPER_ADMIN_ROLES.SUPER_ADMIN]: {
    ...
    [MODULES.SUBSCRIPTION_BILLING]: [ACTIONS.CREATE, ACTIONS.READ, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.EXPORT, ACTIONS.APPROVE],
  ...
  [SUPER_ADMIN_ROLES.FINANCE_ADMIN]: {
    [MODULES.SUBSCRIPTION_BILLING]: [ACTIONS.CREATE, ACTIONS.READ, ACTIONS.UPDATE, ACTIONS.EXPORT, ACTIONS.APPROVE],
    [MODULES.ANALYTICS_MONITORING]: [ACTIONS.READ, ACTIONS.EXPORT],
    [MODULES.REPORTS_CENTER]: [ACTIONS.READ, ACTIONS.EXPORT, ACTIONS.CREATE],
    [MODULES.AUDIT_LOGS]: [ACTIONS.READ]
  },
